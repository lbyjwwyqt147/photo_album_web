...
var ImagesView = {
    ...
    imagesListHtmlAppend:function (rowId, v) {
        ...
        images_col_div += '<a href="#" class="'+rowId+'_edit_btn m-nav__link"  value = "'+v.id+'">\n';
        ...
        if (v.status != 0) {
            images_col_div += '<li class="m-nav__item">\n';
            images_col_div += '<a href="#" class="'+rowId+'_publish_btn m-nav__link"  value = "'+v.id+'">\n';
        ...
        if (v.status == 0) {
            images_col_div += '<li class="m-nav__item">\n';
            images_col_div += '<a href="#" class="'+rowId+'_hide_btn m-nav__link"  value = "'+v.id+'">\n';
        ...
        images_col_div += '<li class="m-nav__item">\n';
        images_col_div += '<a href="#" class="'+rowId+'_del_btn m-nav__link"  value = "'+v.id+'">\n';
